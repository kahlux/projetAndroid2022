...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder> {
    ...
    public SearchAdapter(Context context, List<Resource> mData, ResourceItemClickListener listener) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            TvTitle = itemView.findViewById(R.id.search_item_text);
            ImgMovie = itemView.findViewById(R.id.search_item_img);
